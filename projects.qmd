...
The only way to access all recorded high school recruits is via the 247 player search tool, which is very inefficient as it requires scrolling through the entire list of recruits. Furthermore, there is no simple way to extract this data. This tool overcomes this problem.
